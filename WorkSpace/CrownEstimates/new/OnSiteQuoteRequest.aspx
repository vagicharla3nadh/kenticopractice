    ...
    <style type="text/css">
        ...
        @media screen and (max-width: 875px){
            *, :after, :before {
            ...
            .details .details-form td, td {
                width: 100%;
            }

            .quote input[type="text"], .quote input[type="password"] {
                width: 100% !important;
            }
            ...
            .QuickQuoteOnSite .details-form td select {
                width: 100% !important;
            }

            .ConsultantComments > textarea{
                width: 100%;
            }
                    ...
                    <asp:Panel ID="pnlWizard" CssClass="PanelWizard" runat="server">
                                ...
                                <asp:Wizard ID="w" runat="server" OnActiveStepChanged="w_ActiveStepChanged" DisplaySideBar="false">
                                    <WizardSteps>
                                        ...
                                        <asp:WizardStep ID="ws2" runat="server" Title="Room Selection">
                                            ...
                                            <p>
                                                <asp:Literal ID="litPrintBlankHouseInventory" runat="server" /></p>
                                            ...
                                            <asp:Repeater ID="rpRoomSelect" runat="server" OnItemCreated="rpRoomSelectRepeater_ItemCreated">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="Step2RoomName">
                                                            <asp:Label ID="litRoomName" runat="server" Text='<%#Eval("RoomName")%>' Visible="false" /><%#Eval("RoomName")%></p>
                        ...
                        <div class="secondary-content">
                            ...
                            <ul class="NavigationSteps">
                                <li class="RightMenuNumbers" <%=SetStepTabStyle(0)%>>
                                    <asp:LinkButton ID="btnStep1" runat="server" CommandArgument="0" Text="1. Your Details" OnClick="ChangeStep" /></li>
                                <li class="RightMenuNumbers" <%=SetStepTabStyle(1)%>>
                                    <asp:LinkButton ID="btnStep2" runat="server" CommandArgument="1" Text="2. Room Selection" OnClick="ChangeStep" /></li>
                            </ul>
                            ...
                            <div class="NavigationButtons">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="right">
                                            <asp:ImageButton ID="btnSendNow" runat="server" OnClick="btnSendNow_Click" OnClientClick=" dataLayer.push({'event': 'HomeVisitRequestEvent','eventCategory': 'HomeVisit','eventAction': 'Click','eventLabel': 'Completed Home Visit Request form'});" AlternateText="Send now" ImageUrl="~/images/Send.jpg" EnableViewState="false" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
