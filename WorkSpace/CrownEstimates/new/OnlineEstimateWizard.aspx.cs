...
";
    ...
    protected void btnSendNow_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            EmailHelper.SendCompletedQuoteCrownEmail(Quote, "Crown Relocations - Full Quote Request");
            ...
            //    {
                ...
                //else
                //{
                //    LeadIntegration.LeadNotSent(Quote, "Crown Relocations - Full Quote Request");
            //    }
            //}
            ...
            if (chkSendCopyTo.Checked)
                EmailHelper.SendCompletedQuoteCustomerEmail(Quote, "Crown Relocations - Full Quote Request");
