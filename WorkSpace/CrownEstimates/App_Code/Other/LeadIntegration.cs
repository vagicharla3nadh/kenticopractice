...
public class LeadIntegration
{
    ...
    public static void SendLeadToCrownGlobalSite(Quotes quote, string SubjectLine)
    {
        ...
        string strURL = "https://wag01.crownrelo.com/CrownGateway/create/webLead";//Live Environment
        ...
        try
        {
                ...
                {//If it is an estimate (Big Form) - Get the Inventory Data
                    ...
                    catch (Exception errTotalInventory)
                    {
                        ...
                        SendEmail(email, quote.Email, "dev@uniondigital.co.nz");                        
                    }
				}
				//else
                ...
                sb.AppendFormat("<leadSource>{0}</leadSource>", "Crown website");
