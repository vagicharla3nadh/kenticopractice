			...
			<div class="details-form-Width">
				<table class="details-form">
				  ...
				  <tr>
					...
					<asp:TextBox ID="txtDayPhone" runat="server" MaxLength="30" CssClass="QuoteTextBoxField" Text="09955522"/>
					</td>                    
					<td>
						<label>Email:</label><span class="mandatory">*</span>
						<asp:TextBox ID="txtEmail" runat="server" MaxLength="100" CssClass="QuoteTextBoxField" Text="dev@uniondigital.co.nz"/>
					</td>
				  </tr>
				  <tr>
