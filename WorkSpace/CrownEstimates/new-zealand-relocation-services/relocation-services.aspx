<%@ Page Language="C#" AutoEventWireup="true" CodeFile="relocation-services.aspx.cs" Inherits="new_zealand_relocation_services_relocation_services" %>
...
<head runat="server">
    ...
    <title>Relocation Services | Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<div id="left">
<div id="left-content">
<p><img src="../images/welcome-mat.jpg" alt="Relocation Services" /></p>
<h1>Relocation Services</h1>
<p class="grey-big">Companies invest a great deal of time and money on international assignments and permanent relocations.  Family is the key factor in any move and all aspects related to family must be meticulously taken care of to ensure a successful relocation.</p>
<p>Each relocation is different and every aspect must be treated on a case-by-case basis.</p>
<ul>
<li>Welcome Pack</li>
<li>Preview Visit</li>
<li>Orientation Tour</li>
<li>Home Search</li>
...
<p>Our dedicated team of consultants can provide on the ground support and advise at every major city in the world and across New Zealand.  No other relocation company can offer such a depth of expertise.</p> 


<div class="button"><a class="email" href="mailto:nz@crownrelo.com?subject=Relocation Services" title="Email us">&nbsp;</a></div>
