	...
	<div class="primary-content clearfix">
		<h1>Full Quote</h1>        
			   ...
			   <div id="LoginLinkStep1Only" runat="server" visible="false">                
							<a href="http://www.crownrelo.co.nz/Get-a-Quote/Full-Quote/Login-Page.aspx" target="_top" class="LoginLinkForStep">Login to complete your saved quotation</a>                
				</div>
...
<asp:Wizard ID="w" runat="server" OnActiveStepChanged="w_ActiveStepChanged" DisplaySideBar="false">
	...
	<div class="NavigationButtons NavigationButtonsTop">
		<table width="100%">
		<tr><td align="left">
		   <asp:ImageButton ID="btnBackTop" runat="server" OnClick="btnBack_Click" ImageUrl="~/images/quote-back.jpg" AlternateText="Back" CausesValidation="false" EnableViewState="false" />
		   </td><td>
		   <asp:ImageButton ID="btnSaveTop" runat="server" OnClick="btnSave_Click" ImageUrl="~/images/quote-save.jpg" AlternateText="Save" EnableViewState="false"  CssClass="silentooltip" OnClientClick="_gaq.push(['_trackEvent', 'Full Quote Form', 'Form Saved']);" /> 
		   </td><td align="right">
		   <asp:ImageButton ID="btnNextTop" runat="server" OnClick="btnNext_Click" ImageUrl="~/images/quote-next.jpg" AlternateText="Next" EnableViewState="false"  CssClass="silentooltip" />
		   </td><td align="right">
		   <asp:ImageButton ID="btnSendNowTop" runat="server" OnClick="btnSendNow_Click" AlternateText="Send now" ImageUrl="~/images/quote-sendnow.jpg" EnableViewState="false"  CssClass="silentooltip" OnClientClick="_gaq.push(['_trackEvent', 'Full Quote Form', 'Form Submitted']);" />          
		   </td></tr>
		</table>
		</div>
...
<div class="clearfix"></div>
		...
		<table width="100%">
		<tr><td align="left">
		   <asp:ImageButton ID="btnBack" runat="server" OnClick="btnBack_Click" ImageUrl="~/images/quote-back.jpg" AlternateText="Back" CausesValidation="false" EnableViewState="false" />
		   </td><td>
		   <asp:ImageButton ID="btnSave" runat="server" OnClick="btnSave_Click" ImageUrl="~/images/quote-save.jpg" AlternateText="Save" EnableViewState="false"  CssClass="silentooltip" OnClientClick="_gaq.push(['_trackEvent', 'Full Quote Form', 'Form Saved']);" /> 
		   </td><td align="right">
		   <asp:ImageButton ID="btnNext" runat="server" OnClick="btnNext_Click" ImageUrl="~/images/quote-next.jpg" AlternateText="Next" EnableViewState="false"  CssClass="silentooltip" />
		   </td><td align="right">
		   <asp:ImageButton ID="btnSendNow" runat="server" OnClick="btnSendNow_Click" AlternateText="Send now" ImageUrl="~/images/quote-sendnow.jpg" EnableViewState="false"  CssClass="silentooltip" OnClientClick="_gaq.push(['_trackEvent', 'Full Quote Form', 'Form Submitted']);" />          
		   </td></tr>
		</table>
		</div>
