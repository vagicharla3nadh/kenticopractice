<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shipment-of-household-goods.aspx.cs" Inherits="shipment_of_household_goods" %>
<%@ Register TagPrefix="uc" TagName="UCFeedbackForm" Src="~/controls/UCFeedbackForm.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>Shipment of your Household Goods | Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<div id="left-content">
<img src="images/shipment-of-household.jpg" />
<h1>Shipment of your Household Goods</h1>
<p class="grey-big">Our experienced team of New Zealand based Move Management specialists can arrange everything for you. We will assist you to source competitive quotes, choose the best option and once a mover has been chosen we manage the entire move every step of the way.</p>

<p>The benefits of choosing Crown New Zealand to manage your move include:</p>

    <ul>
    <li>We will source quotations on your behalf through our network of approved service partners.</li>
    <li>You don't need to pay before you leave, we will invoice you in New Zealand in local currency.</li>
    <li>We will insure your shipment in New Zealand, any issues are easily resolved locally.</li>
    <li>We will manage your shipment every step of the way through one point of contact.</li>
    <li>We have no hidden costs, standard NZ Customs and MAF fees are all in your quotation.</li>
    </ul>


<p class="clear" />

<uc:UCFeedbackForm ID="ff" runat="server" />
