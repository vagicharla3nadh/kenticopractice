<%@ Page Language="C#" AutoEventWireup="true" CodeFile="temporary-work-visas.aspx.cs" Inherits="immigration_services_temporary_work_visas" %>
...
<head runat="server">
    ...
    <title>Temporary Work Visas | Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<div id="left-content">
<h1>Temporary Work Visas</h1>
<p class="grey-big">These visas are ideal as a starting point to experience life in New Zealand as it allows you to
work for a set time, usually for as long as your employment contract is valid for.</p>

<p><strong>Working Holiday Visa</strong> – Perfect for the working holiday while you are seeing the world. It
is usually valid for up to 12 months or 23 months if you are from the UK. There is also an
option for a work exchange programme if you are under 35 – See <a href="http://www.bunac.org" target="_blank">BUNAC</a> for more information</p>

<h2>Essential Skills </h2>
 <p> This visa would be ideal for those who have a job offer in New Zealand.</p>
  
  <h2>Silver Fern Job Search Visa</h2>
  <p>This would be suitable for highly skilled people, aged 20-35,
  with a recognized qualification. This visa will allow you to come to New Zealand for 9 months
  and search for work. There are only 300 of these visas issued every year.</p>
  
  <h2>Silver Fern Practical Experience</h2>
  <p>Once you have found skilled employment on the Silver Fern
  Job Search visa you can apply for this visa. This visa allows you to work in New Zealand for
  up to 2 years.</p>
  
  <p>Also, if you’re studying full time in New Zealand you may have additional visa options to
  choose from.</p>

<div class="button"><a class="email" href="mailto:nz@crownrelo.com?subject=Immigration Enquiry - Temporary Skilled" title="Email us">&nbsp;</a></div>


<div id="movingnz-form"><p>Or fill out the form below:</p></div>
...
<div id="get-quote-panel"><a href="#"><img src="../images/get-a-quote.jpg" alt="Get a Quote" /></a></div>
