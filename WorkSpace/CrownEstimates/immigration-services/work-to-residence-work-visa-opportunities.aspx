<%@ Page Language="C#" AutoEventWireup="true" CodeFile="work-to-residence-work-visa-opportunities.aspx.cs" Inherits="immigration_services_work_to_residence_work_visa_opportunities" %>
...
<head runat="server">
    ...
    <title>Work to Residence | Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<p class="grey-big">Talent (Accredited Employers) </p><p>These are perfect for people with job offers from accredited employers</p>

<p class="grey-big">Long Term Skills Shortage List </p><p> For people in occupations on the long-term skills shortage list (link to this list – but in a separate box)</p>

<p class="grey-big">Talent (Arts, Culture and Sports)</p><p>These are for people with exceptional talent in a recognized field as listed.</p>

<div class="button"><a class="email" href="mailto:nz@crownrelo.com?subject=Immigration Enquiry - Work to Residence" title="Email us">&nbsp;</a></div>
