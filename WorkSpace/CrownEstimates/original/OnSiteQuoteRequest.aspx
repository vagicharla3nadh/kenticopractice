...
<asp:Wizard ID="w" runat="server" SideBarStyle-VerticalAlign="Top" Width="100%" OnActiveStepChanged="w_ActiveStepChanged" DisplaySideBar="false">
        <WizardSteps>
                ...
                <table width="100%">
                  <tr>
                    <td colspan="7">
                       ...
                       <asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="txtDayPhone"   Display="None" ErrorMessage="Please enter a day phone name" />
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:DropDownList ID="ddCountryFrom" runat="server" EnableViewState="false" Width="155px">
            ...
            <asp:WizardStep ID="ws2" runat="server" Title="Room Selection">
              ...
              <p style="color:White">Almost done!  You can provide any further comments you wish to make&#8230;then press Send Now&#8230;</p>
              
              <p><asp:Literal ID="litPrintFullHouseInventoryLink" runat="server"/></p>
	    ...
	    <div style=" text-align:right;">
	        <asp:ImageButton ID="btnBack" runat="server" CausesValidation="false" OnClick="btnBack_Click" ImageUrl="~/images/back.gif" AlternateText="Back" Width="71" Height="35" EnableViewState="false" />
            ...
            <asp:ImageButton ID="btnNext" runat="server" OnClick="btnNext_Click" ImageUrl="~/images/next.gif" AlternateText="Next" width="70" Height="35" EnableViewState="false" />
            <asp:ImageButton ID="btnSendNow" runat="server" OnClick="btnSendNow_Click" AlternateText="Send now" ImageUrl="~/images/sendnow.gif" Width="96"  Height="35" EnableViewState="false" />  
	    </div>
	</div>
	</td>	
	</tr>
    ...
    <asp:Panel ID="pnlWizardThankyou" Visible="false" runat="server">
        <p></p>
        <p>Thanks for completing the Quote Request.</p>
