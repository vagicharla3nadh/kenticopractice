...
{
    [Serializable]
    public class CaptchaImage : ISerializable
    {
        #region Public Enums
        ...
        public CaptchaImage(SerializationInfo information, StreamingContext context)
        {
            _generatedAt = information.GetDateTime("_generatedAt");
            _guid = information.GetString("_guid");
            _rand = (Random)information.GetValue("_rand", typeof(Random));
            _backgroundNoise = (BackgroundNoiseLevel)information.GetInt32("_backgroundNoise");
            _fontFamilyName = information.GetString("_fontFamilyName");
            _fontWarp = (FontWarpFactor)information.GetInt32("_fontWarp");
            _fontWhitelist = information.GetString("_fontWhitelist");
            _height = information.GetInt32("_height");
            _lineNoise = (LineNoiseLevel)information.GetInt32("_lineNoise");
            _randomText = information.GetString("_randomText");
            _randomTextChars = information.GetString("_randomTextChars");
            _randomTextLength = information.GetInt32("_randomTextLength");
            _width = information.GetInt32("_width");
        }
        ...
        {
            info.AddValue("_generatedAt", _generatedAt);
            info.AddValue("_guid", _guid);
            info.AddValue("_rand", _rand);
            info.AddValue("_backgroundNoise", _backgroundNoise);
            info.AddValue("_fontFamilyName", _fontFamilyName);
            info.AddValue("_fontWarp", _fontWarp);
            info.AddValue("_fontWhitelist", _fontWhitelist);
            info.AddValue("_height", _height);
            info.AddValue("_lineNoise", _lineNoise);
            info.AddValue("_randomText", _randomText);
            info.AddValue("_randomTextChars", _randomTextChars);
            info.AddValue("_randomTextLength", _randomTextLength);
