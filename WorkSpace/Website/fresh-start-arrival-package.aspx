<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fresh-start-arrival-package.aspx.cs" Inherits="fresh_start_arrival_package" %>
<%@ Register TagPrefix="uc" TagName="UCFreshStartFeedbackForm" Src="~/controls/ucFreshStartFeedbackForm.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Fresh Start Arrival Package | Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<div id="left-content">
<p><img src="images/fresh-start-arrival.jpg" /></p>
<h1>Fresh Start Arrival Package</h1>
<p class="grey-big">We help individuals and families move globally every day and understand the immense stress involved in arriving and settling in your new country. Our Fresh Start support programme has been specifically designed with this in mind. Even if you are returning home, let us take care of the basics.</p>

      <ul>
      <li>
        <h2>Arrival at the airport.</h2>
          After you cleared through customs at the airport, you will be met by our friendly driver who will take care of you and your luggage.
      </li>

      <li><h2>Arrival at accommodation.</h2>
      You will find that the cupboards are stocked with essentials, which means you don’t have the added inconvenience of finding a grocer when you first arrive.</li>
      <li><h2>Finding your feet.</h2>
      You will have the advantage of a one on one session with a professional Relocation Consultant; they will assist with all the important aspects of your new life such as banking, housing, education, culture, transport, amenities and anything that you need to know to be comfortable. We will host an orientation tour to familiarise you with your neighbourhood and to make sure we covered everything you require we will do a comfort call the following week.</li>
      </ul>


      <h2>Helping you through this important time</h2>

      <p>Fresh Start is cost effective and flexible with three options for one-on-one assistance and you can extend your programme at any stage to suit your needs. The rates are as follows:</p>

    <ul><li>Full package + 2 hour orientation tour - NZ$600.00</li>
    <li>Full package + 4 hour orientation tour - NZ$750.00</li>
    <li>Full package + 6 hour orientation tour - NZ$890.00</li>
</ul>

<uc:UCFreshStartFeedbackForm ID="ff" runat="server" />
