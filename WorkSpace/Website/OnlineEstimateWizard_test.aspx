<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlineEstimateWizard_test.aspx.cs" Inherits="OnlineEstimateWizard" EnableEventValidation="false" %>
...
<asp:Wizard ID="w" runat="server" OnActiveStepChanged="w_ActiveStepChanged" DisplaySideBar="false">
    ...
    <div class="NavigationButtons NavigationButtonsTop">
        ...
        <tr><td align="left">
           ...
           <asp:ImageButton ID="btnSaveTop" runat="server" OnClick="btnSave_Click" ImageUrl="~/images/quote-save.jpg" AlternateText="Save" EnableViewState="false"  CssClass="silentooltip" /> 
           </td><td align="right">
           ...
           <asp:ImageButton ID="btnSendNowTop" runat="server" OnClick="btnSendNow_Click" AlternateText="Send now" ImageUrl="~/images/quote-sendnow.jpg" EnableViewState="false"  CssClass="silentooltip" />          
           </td></tr>
        </table>
        </div>
...
<div class="clearfix"></div>
        ...
        <tr><td align="left">
           ...
           <asp:ImageButton ID="btnSave" runat="server" OnClick="btnSave_Click" ImageUrl="~/images/quote-save.jpg" AlternateText="Save" EnableViewState="false"  CssClass="silentooltip" /> 
           </td><td align="right">
           ...
           <asp:ImageButton ID="btnSendNow" runat="server" OnClick="btnSendNow_Click" AlternateText="Send now" ImageUrl="~/images/quote-sendnow.jpg" EnableViewState="false"  CssClass="silentooltip" />          
           </td></tr>
        </table>
        </div>
