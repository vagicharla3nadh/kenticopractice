<%@ Page Language="C#" AutoEventWireup="true" CodeFile="work-to-residence-visa.aspx.cs" Inherits="immigration_services_work_to_residence_visa" %>
...
<head runat="server">
    ...
    <title>Work to Residence Work Visa Opportunities | Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<div id="left-content">
<h1>Work to Residence Work Visa Opportunities</h1>
<p>These visas allow you to work and stay in New Zealand for up to 30 months. This works well if you are unsure how long you will stay but want the option to apply for a residence visa. It’s also great for people who don’t qualify for residence yet but want the work experience to apply for residence later. These visas do not guarantee residence but is used as a first step to becoming a resident in New Zealand.</p>

<h2>Talent (Accredited Employers) </h2><p>These are perfect for people with job offers from accredited employers</p>

<h2>Long Term Skills Shortage List </h2><p> For people in occupations on the long-term skills shortage list (link to this list – but in a separate box)</p>

<h2>Talent (Arts, Culture and Sports)</h2><p>These are for people with exceptional talent in a recognized field as listed.</p>

<div class="button"><a class="email" href="mailto:nz@crownrelo.com?subject=Immigration Enquiry - Work to Residence Work Visa Opportunities" title="Email us">&nbsp;</a></div>
