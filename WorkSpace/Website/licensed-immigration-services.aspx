<%@ Page Language="C#" AutoEventWireup="true" CodeFile="licensed-immigration-services.aspx.cs" Inherits="licensed_immigration_services" %>
<%@ Register TagPrefix="uc" TagName="UCImmigrationFeedbackForm" Src="~/controls/ucImmigrationFeedbackForm.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Licensed Immigration Services| Crown Relocations | New Zealand Moving Company | Furniture Movers | International Relocations | Storage | House Removals</title>
...
<div id="left-content">
<h1>Licensed Immigration Services from Crown Relocations</h1>



<p class="grey-big">On May 4th 2009, it became a legal requirement for all New Zealand Immigration Advisors to
be licensed. As part of our commitment to comprehensive customer service, we are proud to
announce that Crown are the only full service relocation company in New Zealand to have fully
licensed Immigration Advisers in house.</p>
<img alt="IAA Licensed Immigration Advisors" src="images/immigration-logos.gif" height="83" width="236" class="alignright">
<p>Our licensed Immigration Services are designed to help
individuals who are planning their own move to New Zealand, as well as provide assistance and
advice to corporate clients who are looking for external immigration support for their current and
prospective employees.</p>

<p>Crown understands that moving to a new country is a special event that can be a stressful time
for employers, individuals and families of all ages. Our Immigration Service team endeavour to
take away these pressures and ensure a stress free and seamless relocation experience for all
concerned.</p>

<p>Our experienced and licensed team is here to deliver a total immigration support programme in
a practical and cost effective fashion, across the entire range of immigration matters. They have
considerable experience, and have already achieved a very high level of success for our clients.</p>

<div class="button"><a class="email" href="mailto:nz@crownrelo.com?subject=Licensed Immigration Services" title="Email us">&nbsp;</a></div>

<uc:UCImmigrationFeedbackForm ID="ff" runat="server" />
