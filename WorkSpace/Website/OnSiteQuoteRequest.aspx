...
<div class="NavigationButtons NavigationButtonsTop">
		<table width="100%">
			<tr>
			   <td align="left">
				   ...
				   <asp:ImageButton ID="btnSaveTop" runat="server" OnClick="btnSave_Click" ImageUrl="~/images/quote-save.jpg" AlternateText="Save" EnableViewState="false"   CssClass="noDisplay" OnClientClick="_gaq.push(['_trackEvent', 'Quick Quote Form', 'Form Saved']);" /> 
				   </td><td align="right">
				   ...
				   <asp:ImageButton ID="btnSendNowTop" runat="server" OnClick="btnSendNow_Click" AlternateText="Send now" ImageUrl="~/images/quote-sendnow.jpg" EnableViewState="false"  CssClass="silentooltip" OnClientClick="_gaq.push(['_trackEvent', 'Quick Quote Form', 'Form Submitted']);" />          
			   </td>
		   </tr>
		</table>
		</div>
		...
		<table width="100%">
		<tr><td align="left">
			<asp:ImageButton ID="btnBack" runat="server" CausesValidation="false" OnClick="btnBack_Click" ImageUrl="~/images/quote-back.jpg" AlternateText="Back" EnableViewState="false" />
			</td><td>
			<asp:ImageButton ID="btnSave" runat="server" OnClick="btnSave_Click" ImageUrl="~/images/quote-save.jpg" AlternateText="Save" EnableViewState="false" CssClass="noDisplay" OnClientClick="_gaq.push(['_trackEvent', 'Quick Quote Form', 'Form Saved']);" />
			</td><td align="right">
			<asp:ImageButton ID="btnNext" runat="server" OnClick="btnNext_Click" ImageUrl="~/images/quote-next.jpg" AlternateText="Next" EnableViewState="false" />            
			</td><td align="right">
			<asp:ImageButton ID="btnSendNow" runat="server" OnClick="btnSendNow_Click" OnClientClick="_gaq.push(['_trackEvent', 'Quick Quote Form', 'Form Submitted']);" AlternateText="Send now" ImageUrl="~/images/quote-sendnow.jpg" EnableViewState="false" />
			</td></tr>
		</table>
		</div>
